...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showArticlesTemplate = __webpack_require__(8);
	var showGuestArticlesTemplate = __webpack_require__(28);
	var showArticleTemplate = __webpack_require__(29);
	var showGuestArticleTemplate = __webpack_require__(30);
	var config = __webpack_require__(6);
	...
	var signInGuest = function signInGuest() {
	  return $.ajax({
	...
	var showArticles = function showArticles(data) {
	  return $.ajax({
	    headers: {
	      'Authorization': 'Token token=' + store.userToken
	    },
	...
	var searchArticles = function searchArticles(data) {
	  return $.ajax({
	    headers: {
	      'Authorization': 'Token token=' + store.userToken
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <h1 class=\"galleryItem\" data-id=\""
	    ...
	    + "</strong></h1>\n  <div class=\"galleryItem\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <p>Article ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</p>\n    <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
	    + "</p>\n    <span>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#postCommentModal\">\n              Post Comment\n    </button>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#updateCommentModal\">\n              Update Comment\n    </button>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#deleteCommentModal\">\n              Delete Comment\n    </button>\n  </span>\n    <br></br>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </div>\n";
	  ...
	  return "<h1> Articles </h1>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.article : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <h1 class=\"galleryItem\" data-id=\""
	    ...
	    + "</p>\n    <span>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#postCommentModal\">\n              Post Comment\n    </button>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#updateCommentModal\">\n              Update Comment\n    </button>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#deleteCommentModal\">\n              Delete Comment\n    </button>\n  </span>\n    <br></br>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.article : depth0)) != null ? stack1.comments : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onShowArticles = function onShowArticles() {
	  api.showArticles().then(ui.showArticlesSuccess).catch(ui.showArticlesFailure);
	};
	var onSearchArticles = function onSearchArticles(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.searchArticles(data).then(ui.searchArticlesSuccess).catch(ui.searchArticlesFailure);
	};
	var onCreateArticle = function onCreateArticle(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createArticle(data).then(ui.createArticleSuccess).catch(ui.createArticleFailure);
	};
	var onUpdateArticle = function onUpdateArticle(event) {
	  event.preventDefault();
	  store.article_id = $('.article-id').val();
	  var data = getFormFields(event.target);
	  api.updateArticle(data).then(ui.updateArticleSuccess).catch(ui.updateArticleFailure);
	};
	var onDeleteArticle = function onDeleteArticle(event) {
	  event.preventDefault();
	  store.article_id = $('.delete-article-id').val();
	  api.deleteArticle().then(ui.deleteArticleSuccess).catch(ui.deleteArticleFailure);
	};
	...
	var onDeleteComment = function onDeleteComment(event) {
	  ...
	  api.deleteComment().then(ui.deleteCommentSuccess).catch(ui.deleteCommentFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showArticlesSuccess = function showArticlesSuccess(data) {
	  $('.article-container').empty();
	  var showArticlesHtml = void 0;
	  if (!store.guest) {
	...
	var showArticlesFailure = function showArticlesFailure(data) {
	  $('.notifications').empty();
	  $('.modal-title').empty();
	  $('.modal-title').append('Error! Please reload the page');
	};
	var searchArticlesSuccess = function searchArticlesSuccess(data) {
	  $('.article-container').empty();
	  var showArticleHtml = void 0;
	  if (!store.guest) {
	...
	var searchArticlesFailure = function searchArticlesFailure(data) {
	  $('.notifications').empty();
	  $('.modal-title').empty();
	  $('.notifications').append('Error! Article you are looking for does not exist');
	};

	var createArticleSuccess = function createArticleSuccess(data) {
	  $('.notifications').empty();
	...
	var createArticleFailure = function createArticleFailure(data) {
	  $('.notifications').empty();
	  $('.modal-title').empty();
	...
	var updateArticleSuccess = function updateArticleSuccess(data) {
	  $('.notifications').empty();
	...
	var updateArticleFailure = function updateArticleFailure(data) {
	  $('.notifications').empty();
	...
	var deleteArticleFailure = function deleteArticleFailure(data) {
	  $('.notifications').empty();
	...
	var updateCommentFailure = function updateCommentFailure(data) {
	  $('.notifications').empty();
	...
	var deleteCommentFailure = function deleteCommentFailure(data) {
	  $('.notifications').empty();
	...
	module.exports = {
	  ...
	  showArticlesSuccess: showArticlesSuccess,
	  showArticlesFailure: showArticlesFailure,
	  searchArticlesSuccess: searchArticlesSuccess,
	  searchArticlesFailure: searchArticlesFailure,
